...
export default function LoginRegistration() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <MaxWidth>
      <div className="bg-gray-900 shadow-xl rounded-lg overflow-hidden w-full  flex flex-col md:flex-row">
        {/* Left Side Image */}
        <div className="hidden md:flex items-center justify-center w-1/2 bg-gray-900 p-6">
          <img
            src="https://cdni.iconscout.com/illustration/premium/thumb/user-login-4268415-3551776.png"
        ...
        {/* Right Side Form */}
        <div className="w-full md:w-1/2 p-8 md:rounded-l-2xl bg-white">
